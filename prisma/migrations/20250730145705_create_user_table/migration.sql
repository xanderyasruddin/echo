-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('LIKE', 'COMMENT', 'FOLLOW', 'TAGGED');
...
-- CreateIndex
CREATE UNIQUE INDEX "TaggedUser_postId_userId_key" ON "TaggedUser"("postId", "userId");
...
-- AddForeignKey
ALTER TABLE "TaggedUser" ADD CONSTRAINT "TaggedUser_postId_fkey" FOREIGN KEY ("postId") REFERENCES "Post"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
